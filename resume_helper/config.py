...
DEFAULT_RESUME_PATH = PROJECT_ROOT / "users" / "jayne_dough" / "resume_default.pdf"
...
DEFAULT_REFERENCE_DOCX = PROJECT_ROOT / "resumes" / "legacy" / "pandoc_template.docx"
...
def resolve_user_paths(user: str | None = None) -> UserPaths:
    ...
    return UserPaths(
        resume=root / "resume_default.pdf",
