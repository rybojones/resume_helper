...
- **Key Technical Projects** — dynamic. Replace the entire contents of this section with ALL projects selected from CANDIDATE PROJECTS, ordered from most to least relevant to the organization and *typical* DS, MLE and AIE roles for this organization (NOTE: Don't tailor your responses to this specific role)
